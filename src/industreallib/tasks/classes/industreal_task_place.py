...
"""IndustRealLib: Class definition for IndustRealTaskPlace.

This script defines the IndustRealTaskPlace class. The class gets the
observations that are specific to the Place task and can also contain
...
class IndustRealTaskPlace(IndustRealTaskBase):
    """Defines class for Place task."""
