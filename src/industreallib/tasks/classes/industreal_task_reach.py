...
"""IndustRealLib: Class definition for IndustRealTaskReach.

This script defines the IndustRealTaskReach class. The class gets the
observations that are specific to the Reach task and can also contain
...
class IndustRealTaskReach(IndustRealTaskBase):
    """Defines class for Reach task."""
